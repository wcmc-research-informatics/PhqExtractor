...
import gov.va.vinci.ef.pipeline.ExtractorPipeline;
import gov.va.vinci.ef.pipeline.PipelineInterface;
...
public class Service {
  ...
  public void run(File[] configFiles) {
    ...
    try {
      ...
      log.info("Using ExtractorPipeline Pipe");
      PipelineInterface pipe = new ExtractorPipeline();
