 ...
 * @generated */
public class PhqRelation extends Link {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(PhqRelation.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected PhqRelation() {/* intentionally empty block */}
   ...
   */
  public PhqRelation(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public PhqRelation(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
