 ...
 * @generated */
public class QuestionScore extends Regex {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(QuestionScore.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected QuestionScore() {/* intentionally empty block */}
   ...
   */
  public QuestionScore(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public QuestionScore(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public QuestionScore(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
